...
class ScheduleViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var selectedDays: [Bool] = Array(repeating: false, count: 7) // Массив для хранения состояния переключателей
    ...
    func setupUI() {
        ...
        tableView.rowHeight = 75  // Устанавливаем высоту строки
        tableView.tableFooterView = UIView()  // Убирает лишние линии
        ...
        NSLayoutConstraint.activate([
            ...
            containerView.heightAnchor.constraint(equalToConstant: 525),  // 7 дней * 75 пунктов на день
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        daySwitch.onTintColor = .systemBlue // Синий цвет переключателя
        daySwitch.tag = indexPath.row // Используем тег, чтобы знать, какой день изменился
